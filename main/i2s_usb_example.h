...
#define EXAMPLE_I2S_DMA_FRAME_NUM       2048

/* I2S port and GPIOs (STAŁE pod PCM5102A) */
#define EXAMPLE_I2S_NUM                 (0)
#define EXAMPLE_I2S_MCK_IO              GPIO_NUM_10
#define I2S_BCK_PIN           11    // Bit Clock (BCLK)
#define I2S_WS_PIN            12    // Word Select / LRC
#define I2S_DO_PIN            13    // Data Out (DIN dla DAC)
